...
export const TYPES: Record<AnimalKey, AnimalType> = {
  dog: {
    ...
    desc: '사람들과 어울리는 걸 좋아하고 분위기를 밝게 만드는 타입. 처음 만난 사람과도 금방 친해지는 편이고, 친구의 기분도 잘 살펴주는 편이야.',
  ...
  cat: {
    ...
    desc: '남들이 뭐라고 하든 자신의 취향과 속도를 중요하게 생각하는 타입. 혼자만의 시간도 잘 즐기고, 좋아하는 것이 확실한 편이야.',
  ...
  rabbit: {
    ...
    desc: '상대방의 감정을 잘 살피고 주변 사람들을 세심하게 챙기는 타입. 친구와의 관계에서 배려와 조화를 중요하게 생각해.',
  ...
  fox: {
    ...
    desc: '새로운 아이디어와 경험을 좋아하고, 남들과 조금 다른 방법을 찾는 타입. "왜?" "만약에?"라는 생각이 많아서 예상하지 못한 아이디어를 잘 떠올려.',
...
export const QUESTIONS: Question[] = [
  {
    ...
    opts: [
      ...
      { text: '기분 안 좋아 보이는 친구한테 간다', w: { rabbit: 2 } },
      { text: '창밖 보며 엉뚱한 상상 시작', w: { fox: 2 } },
    ],
  },
  {
    text: '처음 해보는 활동 앞에서 내 마음은?',
    opts: [
      { text: '재밌겠다! 제일 먼저 손 든다', w: { dog: 2 } },
      { text: '내 방식대로 조용히 해본다', w: { cat: 2 } },
      { text: '친구랑 같이면 할 수 있어', w: { rabbit: 2 } },
      { text: '남들 안 하는 방법부터 찾아본다', w: { fox: 2 } },
    ],
  },
  {
    text: '조별 과제, 내 자리는 어디?',
    opts: [
      { text: '발표하고 분위기 띄우는 사람', w: { dog: 2 } },
      { text: '맡은 거 완벽하게 끝내는 사람', w: { cat: 2 } },
      { text: '다들 잘 하고 있나 챙기는 사람', w: { rabbit: 2 } },
      { text: '새 아이디어 던지는 사람', w: { fox: 2 } },
    ],
  },
  {
    text: '친구가 갑자기 속상하다고 연락했어',
    opts: [
      { text: '바로 전화해서 기운 나게 해준다', w: { dog: 2 } },
      { text: '부담 안 주게 짧게 답해준다', w: { cat: 2 } },
      { text: '무슨 일인지 끝까지 들어준다', w: { rabbit: 2 } },
      { text: '같이 해결 방법을 찾아본다', w: { fox: 2 } },
    ],
  },
  {
    text: '슬라임을 만든다면 제일 중요한 건?',
    opts: [
      { text: '소리가 콰직콰직 재밌어야 함', w: { dog: 2 } },
      { text: '색이 딱 내 취향이어야 함', w: { cat: 2 } },
      { text: '만졌을 때 폭신한 촉감', w: { rabbit: 2 } },
      { text: '아무도 안 만든 조합이어야 함', w: { fox: 2 } },
    ],
  },
  {
    text: '나를 한마디로 표현하면?',
    opts: [
      { text: '밝고 에너지 넘치는 사람', w: { dog: 2 } },
      { text: '취향이 확실한 사람', w: { cat: 2 } },
      { text: '따뜻하고 편한 사람', w: { rabbit: 2 } },
      { text: '엉뚱하고 특별한 사람', w: { fox: 2 } },
    ],
  },
];
