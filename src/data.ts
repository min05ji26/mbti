...
export const QUESTIONS: Question[] = [
  ...
  {
    //5번 질문
    text: 'AI 축제에 가게 됐다! 나는?',
    opts: [
      { text: '친구들과 모여서 새로운 사람과 어울리며 재미있는 부스를 즐긴다.', w: { dog: 1 } },
      { text: '혼자 관심 있는 부스를 천천히 둘러보며 궁금한 것들을 찾아본다.', w: { cat: 1 } },
      { text: '친구들이 어떤 부스를 좋아할지 생각해보고, 모두가 즐길 수 있는 부스를 찾아본다.', w: { rabbit: 1 } },
      { text: '평소 해보지 못한 새로운 AI 체험이나 신기한 부스를 찾아간다.', w: { fox: 1 } },
    ],
  },
  {
    //6번 질문 (조건 달기)
